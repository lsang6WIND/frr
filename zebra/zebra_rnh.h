...
extern void zebra_register_rnh_l2vpn_svc(vrf_id_t vrf_id, struct zebra_l2vpn_svc *svc,
					 bool *nht_exists);
extern void zebra_deregister_rnh_l2vpn_svc(vrf_id_t vrf_id, struct zebra_l2vpn_svc *svc);
