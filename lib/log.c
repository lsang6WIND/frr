...
static const struct zebra_desc_table command_types[] = {
	...
	DESC_ENTRY(ZEBRA_L2VPN_SVC_ADD),
	DESC_ENTRY(ZEBRA_L2VPN_SVC_DELETE),
	DESC_ENTRY(ZEBRA_L2VPN_SVC_SET),
	DESC_ENTRY(ZEBRA_L2VPN_SVC_UNSET),
	DESC_ENTRY(ZEBRA_L2VPN_SVC_STATUS_UPDATE),
